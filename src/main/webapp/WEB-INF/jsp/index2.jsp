    ...
    <div data-options="region:'west',title:'系统菜单',split:true" style="width:200px;">
    	<div id="aa" class="easyui-accordion" style="width:193px;" data-options="border:0,multiple:true" >   
		    <div title="用户管理" data-options="iconCls:'icon-save'" style="overflow:auto;padding:10px;">
		       <ul>
		       	 <li><a href="javascript:void(0)" pageUrl="../jspController/user_manage">用户管理</a></li>
		       </ul>
		    </div>   
		    <div title="电磁管理" data-options="iconCls:'icon-reload',selected:true" style="padding:10px;">
		       <ul>

				   <li><a href="javascript:void(0)"  pageUrl="../jspController/show">展示</a></li>

		       	 <li><a href="javascript:void(0)" pageUrl="../jspController/ele_manage">电场管理</a></li>
		       	 <li><a href="javascript:void(0)" pageUrl="../jspController/air_manage">czml模型管理</a></li>
				   <li><a href="javascript:void(0)" pageUrl="../jspController/heatmap_manage">热图</a></li>
				   <li><a href="javascript:void(0)" pageUrl="../jspController/path_manage">path</a></li>
		       </ul>
		    </div>     
		</div>  
    </div>   
