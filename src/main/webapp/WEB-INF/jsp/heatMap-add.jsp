            ...
            <div class="layui-row">
                <form class="layui-form">
                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-inline">
                            <input type="text" id="L_1" name="west" required="" lay-verify="nikename" autocomplete="off" class="layui-input"></div>
                    </div>
                    <div class="layui-form-item">
                        <label for="L_2" class="layui-form-label">
                            <span class="x-red">*</span>东边界</label>
                        <div class="layui-input-inline">
                            <input type="text" id="L_2" name="east" required="" lay-verify="nikename" autocomplete="off" class="layui-input"></div>
                    </div>
                    <div class="layui-form-item">
                        <label for="L_3" class="layui-form-label">
                            <span class="x-red">*</span>南边界</label>
                        <div class="layui-input-inline">
                            <input type="text" id="L_3" name="south" required="" lay-verify="nikename" autocomplete="off" class="layui-input"></div>
                    </div>
                    <div class="layui-form-item">
                        <label for="L_4" class="layui-form-label">
                            <span class="x-red">*</span>北边界</label>
                        <div class="layui-input-inline">
                            <input type="text" id="L_4" name="north" required="" lay-verify="nikename" autocomplete="off" class="layui-input"></div>
                    </div>
                    <div class="layui-form-item">
                        <label for="L_9" class="layui-form-label">
                            <span class="x-red">*</span>命名</label>
                        <div class="layui-input-inline">
                            <input type="text" id="L_9" name="name" required="" lay-verify="nikename" autocomplete="off" class="layui-input"></div>
                    </div>
                    <div class="layui-form-item">
                        <label for="L_7" class="layui-form-label">
                            <span class="x-red">*</span>data</label>
                        <div class="layui-input-inline">
                            <input type="text" id="L_7" name="data" required="" lay-verify="nikename" autocomplete="off" class="layui-input"></div>
                    </div>
                    <div class="layui-form-item">
                        <label for="L_8" class="layui-form-label">
                            <span class="x-red">*</span>备注</label>
                        <div class="layui-input-inline">
                            <input type="text" id="L_8" name="info" required="" lay-verify="nikename" autocomplete="off" class="layui-input"></div>
                    </div>
