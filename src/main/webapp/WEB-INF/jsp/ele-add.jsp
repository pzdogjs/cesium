            ...
            <div class="layui-row">
                <form class="layui-form">
                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-inline">
                            <input type="text" id="L_2" name="x" required="" lay-verify="x" autocomplete="off" class="layui-input"></div>
                    </div>
                    <div class="layui-form-item">
                        <label for="L_3" class="layui-form-label">
                            <span class="x-red">*</span>纬度</label>
                        <div class="layui-input-inline">
                            <input type="text" id="L_3" name="y" required="" lay-verify="y" autocomplete="off" class="layui-input"></div>
                    </div>
                    <div class="layui-form-item">
                        <label for="L_4" class="layui-form-label">
                            <span class="x-red">*</span>海拔</label>
                        <div class="layui-input-inline">
                            <input type="text" id="L_4" name="height" required="" lay-verify="height" autocomplete="off" class="layui-input"></div>
                    </div>
                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-inline">
                            <input type="text" id="L_5" name="r" required="" lay-verify="r" autocomplete="off" class="layui-input"></div>
                    </div>
                    <div class="layui-form-item">
                        <label for="L_6" class="layui-form-label">
                            <span class="x-red">*</span>命名</label>
                        <div class="layui-input-inline">
                            <input type="text" id="L_6" name="name" required="" lay-verify="name" autocomplete="off" class="layui-input"></div>
                    </div>
                    <div class="layui-form-item">
                        <label for="L_7" class="layui-form-label">
                            <span class="x-red">*</span>频率</label>
                        <div class="layui-input-inline">
                            <input type="text" id="L_7" name="hz" required="" lay-verify="hz" autocomplete="off" class="layui-input"></div>
                    </div>
                    <div class="layui-form-item">
                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-inline">
                            <input type="text" id="L_10" name="type" required="" lay-verify="type" autocomplete="off" class="layui-input"></div>
                    </div>
