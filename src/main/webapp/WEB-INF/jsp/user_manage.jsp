	...
	<div id="win" class="easyui-window" title="客户数据编辑" style="width:500px;height:300px"   
	    ...
	    <form id="editForm" method="post">
	    	...
	    	id:<input type="text" name="id"><br/>
		  	账户名：<input type="text" name="name" class="easyui-validatebox" data-options="required:true"/><br/>
			账户密码：<input type="text" name="password" class="easyui-validatebox" data-options="required:true"/><br/>

				age：<input type="text" name="age" class="easyui-validatebox" data-options="required:true"/><br/>
				gender：<input type="text" name="gender" class="easyui-validatebox" data-options="required:true"/><br/>
				edu：<input type="text" name="edu" class="easyui-validatebox" data-options="required:true"/><br/>
				idcard：<input type="text" name="idcard" class="easyui-validatebox" data-options="required:true"/><br/>
  	...
  	<script type="text/javascript">
  		$(function(){
  			$("#list").datagrid({
  				//url:后台数据查询的地址
  				url:"../userController/show_all.action",
  				//columns：填充的列数据
  					//field:后台对象的属性
  					//tille:列标题
  				columns:[[
  			...
  			$("#editBtn").click(function(){
  				...
  				//表单回显
  				$("#editForm").form("load","../userController/findById.action?id="+rows[0].id);
  			...
  			$("#deleteBtn").click(function(){
  				...
  				$.messager.confirm("提示","确认删除数据吗?",function(value){
  					if(value){
  						...
  						//传递到后台
  						$.post("../userController/del.action",idStr,function(data){
  							if(data.success){
  	  							//刷新datagrid
  	  							$("#list").datagrid("reload");
